...
class TimeSeries:
    ...
    def timeseries_random(self, data, size, x_labels=None):
        """
        ...
        data_size = self.help.get_data_size(data)

        # check size and get num samples to return
        num_samples = self.help.get_num_samples(size=size, data_size=data_size)
    ...
    def timeseries_interval(self, data, k=0, size=0, x_labels=None):
        """
    ...
    def timeseries_bucket_random(self, data, num_buckets, per_bucket=1, x_labels=None):
        """
    ...
    def timeseries_sliding_window(self, data, w_size, f=np.avg, delta=.1, x_labels=None):
        """
    ...
    def timeseries_LTTB(self, data, size):
        """
        ...
        *** original code found here: https://github.com/devoxi/lttb-py/blob/master/lttb/lttb.py
        ...
        threshold = self.help.__get_num_samples__(size)
